...
{
    public class FinancialReportsViewDuesConfiguration : IEntityTypeConfiguration<FinancialReportsViewDues>
    {
        public void Configure(EntityTypeBuilder<FinancialReportsViewDues> builder)
        {
            builder.ToView("financialreportsviewdues");
            builder.HasNoKey();
